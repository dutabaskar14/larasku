...
<head>
    ...
    <title>Edit Video — LARASKU</title>
            ...
            <section class="card">
                ...
                <div class="meeting-info">
                    ...
                    <div class="meeting-info-title">
                        Video Saat Ini — Pertemuan {{ $video->pertemuan }}
                    </div>

                    <div class="meeting-info-text">
                        Kamu dapat memindahkan video ke pertemuan lain selama
                        pertemuan tujuan belum mencapai 10 video.
                    </div>
                ...
                <form
                    action="{{ route('guru.videos.update', $video) }}"
                    method="POST"
                >
                    ...
                    <div class="field">
                        ...
                        >
                            ...
                            @for($i = 1; $i <= 8; $i++)
                                ...
                                <option
                                    value="{{ $i }}"
                                    {{ (int) old('pertemuan', $video->pertemuan) === $i ? 'selected' : '' }}
                                >
                                    Pertemuan {{ $i }}
                                </option>
                    ...
                    <div class="field">
                        ...
                        <div class="hint">
                            Ganti link jika ingin menggunakan video YouTube yang berbeda.
                        </div>
